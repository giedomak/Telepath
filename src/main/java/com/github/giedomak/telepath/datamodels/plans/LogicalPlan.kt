...
import com.github.giedomak.telepath.datamodels.plans.LogicalPlan.Companion
import com.github.giedomak.telepath.datamodels.plans.LogicalPlan.Companion.CONCATENATION
import com.github.giedomak.telepath.datamodels.plans.utilities.LogicalPlanSubtree
import com.github.giedomak.telepath.datamodels.plans.utilities.MultiTreeContainment
 ...
 *
 * User input will get parsed through ANTLR into a parseTree by the [StaticParserRPQ][com.telepath.staticparser.StaticParserRPQ].
 *
 * The [DynamicProgrammingPlanner][com.telepath.planner.DynamicProgrammingPlanner] will parse such a parseTree from user input, into a physical plan.
 ...
 *
 * @property id An ID given to a parseTree in order to make the life of the [SimpleMemoryManager][com.telepath.memorymanager.SimpleMemoryManager] easier.
