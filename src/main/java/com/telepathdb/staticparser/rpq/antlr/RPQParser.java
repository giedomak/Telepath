...
public class RPQParser extends Parser {
  ...
  public static class BinaryExpressionContext extends QueryContext {
    public BinaryExpressionContext(QueryContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class LeafContext extends QueryContext {
    public LeafContext(QueryContext ctx) {
      copyFrom(ctx);
    }

    public TerminalNode LABEL() {
      return getToken(RPQParser.LABEL, 0);
    }
  ...
  public static class UnaryExpressionContext extends QueryContext {
    public UnaryExpressionContext(QueryContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class ParenthesisContext extends QueryContext {
    public ParenthesisContext(QueryContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class UnaryOperatorContext extends ParserRuleContext {
    ...
    public TerminalNode KLEENE_STAR() {
      return getToken(RPQParser.KLEENE_STAR, 0);
    }

    public TerminalNode PLUS() {
      return getToken(RPQParser.PLUS, 0);
    }
  ...
  public static class BinaryOperatorContext extends ParserRuleContext {
    ...
    public TerminalNode CONJUNCTION() {
      return getToken(RPQParser.CONJUNCTION, 0);
    }

    public TerminalNode UNION() {
      return getToken(RPQParser.UNION, 0);
    }
