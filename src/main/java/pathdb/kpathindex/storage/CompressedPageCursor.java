...
import static pathdb.kpathindex.storage.DiskCache.PAGE_SIZE;
...
public class CompressedPageCursor extends PageProxyCursor {
  ...
  private void compressAndWriteLeaf() {
    ...
    if (decompressedSize != 0) {
      compress();
      inMemoryBlockStorage.writeBytes(NodeHeader.NODE_HEADER_LENGTH, compressedBytes.position(), compressedBytes.array());
