...
public final class NodeHeader {
  ...
  */
  ...
  public static boolean isUninitializedNode(PageCursor cursor) {
    return cursor.getByte(BYTE_POSITION_NODE_TYPE) == 0;
  }

  public static boolean isUninitializedNode(ByteBuffer buffer) {
    return buffer.get(BYTE_POSITION_NODE_TYPE) == 0;
  }
