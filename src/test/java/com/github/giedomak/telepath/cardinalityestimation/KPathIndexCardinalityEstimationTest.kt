...
class KPathIndexCardinalityEstimationTest {
    ...
    fun returnsTheCardinalityOfPathsIds() {
        ...
        val cardinalityEstimation = KPathIndexCardinalityEstimation(Telepath.kPathIndex)
    ...
    fun returnsTheCardinalityOfUnion() {
        ...
        val cardinalityEstimation = spy(KPathIndexCardinalityEstimation(Telepath.kPathIndex))
    ...
    private fun createIndex() {
        ...
        Telepath.kPathIndex = KPathIndexDisk()

        for (_i in 1..10L) {
            for (i in 1..(10 * _i)) {
                Telepath.kPathIndex.insert(Path(i, PathTest.equalNodes(3, "42")))
            }
        }
    }
}
