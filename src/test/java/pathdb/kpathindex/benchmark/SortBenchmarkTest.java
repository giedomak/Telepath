...
import pathdb.kpathindex.pagecachesort.SetIterator;
import pathdb.kpathindex.pagecachesort.Sorter;

public class SortBenchmarkTest {
  Sorter sorter;

  public static void main(String[] args) throws IOException {
    SortBenchmarkTest sortBenchmarkTest = new SortBenchmarkTest();

    sortBenchmarkTest.smallestExample();

    //sortBenchmark.randomSorting();
  }

  public SortBenchmarkTest() throws IOException {
